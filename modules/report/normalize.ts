...
const CATEGORY_KEYWORDS: Array<[string, string[]]> = [
  ...
  ['Exercise', ['gym', 'workout', 'run', 'bike', 'swim', 'yoga', 'hike', 'pilates', 'aerial hoop', 'crossfit', 'training', 'lift', 'cycling']],
  ...
  ['Rest', ['rest', 'relax', 'day off', 'vacation', 'annual leave', 'holiday', 'pto', 'nap']],
]
